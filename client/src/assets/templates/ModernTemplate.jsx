			...
			<header className="p-8 text-white" style={{ backgroundColor: accentColor }}>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm ">
					...
					{data.personal_information?.linkedin && (
						<a target="_blank" href={data.personal_information?.linkedin} className="flex items-center gap-2">
					...
					{data.personal_information?.website && (
						<a target="_blank" href={data.personal_information?.website} className="flex items-center gap-2">
								...
								>
									...
									{p.url && (
										<a
											href={p.url}
											target="_blank"
											className="text-sm font-medium text-blue-600 break-all mt-2 inline-block"
										>
											{p.url}
										</a>
									)}
								...
								{data.education.map((edu, index) => (
									<div key={index}>
										...
										<div className="flex justify-between items-center text-sm text-gray-600">
											<span>{edu.is_current ? "Pursuing" : formatDate(edu.graduation_date)}</span>
