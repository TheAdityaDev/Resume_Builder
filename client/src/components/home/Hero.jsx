...
// --- Skeleton Loader (inside same file) ---
const SkeletonHero = () => {
  return (
    <div className="min-h-screen pb-20 animate-pulse">
      {/* Navbar Skeleton */}
      <nav className="flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40">
        ...
        <div className="flex gap-2">
          <div className="hidden md:block h-8 w-24 bg-slate-200 rounded-full"></div>
          <div className="hidden md:block h-8 w-24 bg-slate-200 rounded-full"></div>
        </div>

        <div className="md:hidden h-6 w-6 bg-slate-200 rounded"></div>
      </nav>

      {/* Hero Section Skeleton */}
      <div className="flex flex-col items-center px-4 md:px-16 lg:px-24 xl:px-40 mt-20">
        {/* Avatars + stars skeleton */}
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="h-3 w-28 bg-slate-200 rounded mt-1"></div>
          </div>
        </div>
        ...
        {/* Description */}
        <div className="h-4 w-60 bg-slate-200 rounded my-7"></div>
        ...
        {/* brands */}
        <div className="h-4 w-64 bg-slate-200 rounded mt-14"></div>

        <div className="flex flex-wrap justify-between max-sm:justify-center gap-6 max-w-3xl w-full py-4 mt-4">
          {Array(5)
            .fill(0)
            .map((_, i) => (
              <div key={i} className="h-6 w-20 bg-slate-200 rounded"></div>
            ))}
        </div>
      </div>
    </div>
...
const Hero = () => {
  ...
  if (loading) return <SkeletonHero />; // ⭐ SHOW SKELETON FIRST
  return (
    <>
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="flex gap-2">
            ...
            <Link to='/app' className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900" hidden={!user}>Dashboard</Link>
          </div>
