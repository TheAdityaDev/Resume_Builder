...
const Features = () => {
  ...
  return (
    ...
    >
      ...
      <Title title='Build Your Resume' description='Our streamlined resume builder makes it easy to create a professional resume in minutes with intelligent AI-powered tool and features.' />

      <div className="flex flex-col md:flex-row items-center justify-center xl:-mt-14">
        <img
